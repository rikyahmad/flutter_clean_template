...
import 'package:flutter_clean_template/presentation/color.dart';
...
class CustomTheme extends ThemeExtension<CustomTheme> {
  const CustomTheme({
    ...
    this.tertiaryColor = colorTertiary,
    this.neutralColor = colorNeutral,
  });
  ...
  ThemeData _base(final Brightness brightness) {
    final colorScheme = brightness == Brightness.dark
        ? _schemeDark().toColorScheme(brightness)
        : _schemeLight().toColorScheme(brightness);

    final primaryTextTheme = GoogleFonts.exoTextTheme();
    final secondaryTextTheme = GoogleFonts.neuchaTextTheme();

    final textColor = brightness == Brightness.dark ? colorTextDark : colorText;
    final appbarColor =
        brightness == Brightness.dark ? colorToolbarDark : colorToolbar;
